...
const FeatureArticle = ({ img, title, time, summary, link }) => {
  return (
    <li className="col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl relative dark:bg-dark dark:border-light ">
      <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2rem] bg-dark rounded-br-3x1 dark:bg-light"></div>
      <Link
        href={link}
        target={"_blank"}
      ...
      <Link href={link} target="_blank">
        <h2 className="capitalize text-2x1 font-bold my-2 mt-4 hover:underline xs:text-lg">
          {title}
        </h2>
      </Link>
...
const articles = () => {
  return (
    <>
      <Head>
        <title>Diego Rojas | articles</title>
