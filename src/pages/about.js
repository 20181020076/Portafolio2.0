...
import profilePic from "../../public/images/profile/fotoAbout.jpeg";
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8 ">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="my-4 font-medium">
                I believe that programming is not just about writing code that
                works - it's about solving complex problems and creating
                efficient, user-friendly applications that enhance the user
                experience.
              </p>
              <p className="font-medium">
            ...
            <div className="col-span-2 flex flex-col items-end justify-between m-0 xl:col-span-8 xl:flex-row xl:items-center md:order-3">
              <div className="flex flex-col items-end justify-center xl:items-center">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl w-full">
                  <AnimatedNumbers value={15} className="text-right" />
                </span>
              ...
              <div className=" flex flex-col items-end justify-center">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl w-full">
                  <AnimatedNumbers value={20} className="text-right" />
                </span>
                <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-light xl:text-center md:text-lg sm:text-base xs:text-sm">
                  Projects completed
                </h2>
              ...
              <div className=" flex flex-col items-end justify-center text-center">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl w-full">
                  <AnimatedNumbers value={3} className="text-right " />
                </span>
                <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-light xl:text-center md:text-lg sm:text-base xs:text-sm">
