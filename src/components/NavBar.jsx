    ...
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav>
          ...
          {/* <CustomLink href="/articles" title="Arcticles" className="ml-4" /> */}
        </nav>
      ...
      {isOpen ? (
        //menu
        <motion.div initial={{scale:0,opacity:0, x:"-50%", y: "-50%"}} animate={{scale:1, opacity:1}} className="z-30 min-w-[70vw] flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32">
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            ...
            <motion.a
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-6 mx-3 text-light sm:mx-1"
            >
